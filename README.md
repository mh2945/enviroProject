## 앱 목적 정의 ( enviroProject 에서는 SwiftUI를 기준으로 초기 작성했지만, storyboard 로 전환 이후 GitAction을 활용한 빌드 자동화를 추가할 예정)
...
CI/CD를 위한 GitHub Action 을 구축하기 위해 1차적으로 연결했으나 현재 오류가 발생 

환경 설정 과정에서 문제가 발생한 것으로 예상
